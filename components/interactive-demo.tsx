      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Take our platform for a test drive with this interactive demo that
            showcases real-world scenarios and capabilities.
          </p>
        </div>
            ...
            <div className="relative z-10">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-300">
                    {isPlaying
                      ...
                      : "Click play to begin the interactive demo"}
                  </p>
                </div>
              </div>
              ...
              <div className="text-center mt-12">
                <p className="text-gray-300 mb-6">
                  Ready to experience the full platform? Start your free trial
                  today.
                </p>

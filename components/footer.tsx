    ...
    <footer className="relative py-20 px-4 sm:px-6 lg:px-8 border-t border-blue-500/20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering the future of digital innovation with AI-powered solutions that transform how you work, create,
              and innovate.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-blue-500/20">
          <p className="text-gray-400 mb-4 md:mb-0">© 2024 NexusAI. All rights reserved.</p>

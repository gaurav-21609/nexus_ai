...
export function ProductShowcase() {
  ...
  const productFeatures = [
    ...
    },
    {
      ...
      description: "Connect with over 1000+ tools and platforms through our robust API ecosystem.",
    },
    {
      title: "Intelligent Automation",
      description: "Automate complex workflows with AI-driven decision making and smart triggers.",
    },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Experience our revolutionary platform through an interactive 3D showcase that demonstrates real-world
            capabilities.
          </p>
        </div>

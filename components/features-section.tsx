...
export function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Military-grade encryption and zero-trust architecture protect your data across all touchpoints.",
      color: "from-green-400 to-blue-500",
    },
    {
      icon: Brain,
      title: "AI-Powered Intelligence",
      description: "Advanced machine learning algorithms adapt and learn from your workflows to optimize performance.",
      color: "from-purple-400 to-pink-500",
    },
    {
      icon: Rocket,
      title: "Rapid Deployment",
      description: "Deploy in minutes, not hours. Our streamlined setup gets you running at full capacity instantly.",
      color: "from-blue-400 to-cyan-500",
    },
    {
      icon: Globe,
      title: "Global Scale",
      description: "Worldwide infrastructure ensures low latency and high availability across all continents.",
      color: "from-indigo-400 to-purple-500",
    },
    {
      icon: Users,
      title: "Team Collaboration",
      description: "Seamless real-time collaboration tools that keep your team synchronized and productive.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the cutting-edge capabilities that make our platform the choice of industry leaders worldwide.
          </p>
        </div>
